        ...
        <section className="general-container">
            <div id="div-exp" className="container-ads d-flex">
                ...
                <div className="ads p-2" id="container-text">
                    ...
                    <h4><img src={Location} id="logo-location" />Ubicación:Tarifa</h4>
                    <h5 className="description">
                        ...
                        En la visita disfrutaremos de la puesta de sol mientras  el guía nos narra la historia del faro
                    </h5>
